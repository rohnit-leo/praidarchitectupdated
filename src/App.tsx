...
export default function App() {
  ...
  return (
    ...
    <div className="fixed bottom-0 left-0 right-0 z-[100] md:hidden flex bg-white pb-[env(safe-area-inset-bottom)] shadow-[0_-20px_40px_rgba(0,0,0,0.15)] border-t border-slate-200">
      <a href="tel:+919150073342" className="flex-1 flex items-center justify-center gap-2 py-4 bg-slate-900 text-white hover:bg-slate-800 transition-colors active:bg-slate-700 border-r border-slate-200">
        <Phone className="w-4 h-4 text-white" />
        <span className="text-[11px] font-montserrat uppercase tracking-widest font-bold">Call Us</span>
      </a>
      <a href="https://wa.me/919150073342" target="_blank" rel="noreferrer" className="flex-1 flex items-center justify-center gap-2 py-4 bg-[#25D366] text-white hover:bg-[#128C7E] transition-colors active:bg-[#0c6b5f]">
      ...
      <div className="hidden md:flex fixed bottom-8 right-8 z-50 flex-col gap-4">
        <a href="https://wa.me/919150073342" target="_blank" rel="noreferrer" className="w-14 h-14 bg-[#25D366] hover:bg-[#128C7E] text-white rounded-full flex items-center justify-center shadow-2xl transition-all hover:scale-110 cursor-pointer">
